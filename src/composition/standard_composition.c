...
#include "standard_composition.h"
#include "../common.h"
#include <string.h>

void perm_compose_standard_non_ct(perm_t out, const perm_t in1, const perm_t in2){
...
void perm_compose_standard(perm_t out, const perm_t in1, const perm_t in2){
