...
#ifndef RANDOM_PERMUTATION_SAMPLING_DJBSORT_COMPOSITION_H
#define RANDOM_PERMUTATION_SAMPLING_DJBSORT_COMPOSITION_H
...
#endif //RANDOM_PERMUTATION_SAMPLING_DJBSORT_COMPOSITION_H
