...
static int djbsort_with_given_random_input_avx(perm_t p, uint32_t buffer[PARAM_N1]) {
    ...
    // sort
    uint32_sort_avx(buffer, PARAM_N1);
 ...
 */
void perm_set_random_djbsort_avx(perm_t p, uint8_t seed[SEED_BYTES]) {
