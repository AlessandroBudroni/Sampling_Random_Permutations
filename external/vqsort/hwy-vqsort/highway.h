...
#include "hwy-vqsort/ops/x86_128-inl.h"
#elif HWY_TARGET == HWY_AVX2
#include "ops/x86_256-inl.h"
#elif HWY_TARGET == HWY_AVX3 || HWY_TARGET == HWY_AVX3_DL || \
    HWY_TARGET == HWY_AVX3_ZEN4 || HWY_TARGET == HWY_AVX3_SPR
#include "ops/x86_512-inl.h"
#elif HWY_TARGET == HWY_PPC8 || HWY_TARGET == HWY_PPC9 || \
    HWY_TARGET == HWY_PPC10
#include "ops/ppc_vsx-inl.h"
#elif HWY_TARGET == HWY_NEON || HWY_TARGET == HWY_NEON_WITHOUT_AES
#include "ops/arm_neon-inl.h"
#elif HWY_TARGET == HWY_SVE || HWY_TARGET == HWY_SVE2 || \
    HWY_TARGET == HWY_SVE_256 || HWY_TARGET == HWY_SVE2_128
#include "ops/arm_sve-inl.h"
#elif HWY_TARGET == HWY_WASM_EMU256
#include "ops/wasm_256-inl.h"
#elif HWY_TARGET == HWY_WASM
#include "ops/wasm_128-inl.h"
#elif HWY_TARGET == HWY_RVV
#include "ops/rvv-inl.h"
#elif HWY_TARGET == HWY_EMU128
#include "ops/emu128-inl.h"
#elif HWY_TARGET == HWY_SCALAR
#include "ops/scalar-inl.h"
#else
#pragma message("HWY_TARGET does not match any known target")
#endif  // HWY_TARGET

#include "hwy-vqsort/ops/generic_ops-inl.h"
