#ifndef RANDOM_PERMUTATION_SAMPLING_HWY_VQSORT_CWRAPPER_H
#define RANDOM_PERMUTATION_SAMPLING_HWY_VQSORT_CWRAPPER_H

#include "hwy-vqsort/sort/vqsort.h"
...
#endif //RANDOM_PERMUTATION_SAMPLING_HWY_VQSORT_CWRAPPER_H